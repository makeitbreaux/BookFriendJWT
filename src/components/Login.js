  ...
  <Fragment>
    ...
    <form className="mt-8 space-y-6" action="#" method="POST" onSubmit={onSubmitForm}>
      ...
      <div className="flex items-center justify-between">
        <button type="submit" onClick={navigateToRegister} className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-black bg-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
